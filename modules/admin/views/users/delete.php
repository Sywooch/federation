...
$this->params['breadcrumbs'][] = ['label' => 'Панель управления пользователями', 'url' => ['/admin/users/index']];
...
<div class="greyBg clear">
    <div class="content">
        ...
        <div class="adminMastersList">
            <p>Выберите пользователей, которых Вы хотите удалить. <br/>
                Кнопка Удалить действует только для текущей части таблицы</p>

            <form action="<?= Url::to(['/admin/users/delete']) ?>" class="hidden">

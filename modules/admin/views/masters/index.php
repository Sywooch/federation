...
$this->title = 'Панель управления мастерами';
...
<div class="greyBg clear">
    <div class="content">
        ...
        <div class="adminMastersList">
            ...
            <ul>
                <li><a href='<?= Url::to(['masters/add']) ?>'>Добавить мастера</a></li>
                <li><a href='<?= Url::to(['masters/all']) ?>'>Редактировать мастеров</a></li>
                <li><a href='<?= Url::to(['masters/send-message']) ?>'>Отправить сообщение мастерам</a></li>
                <li><a href='<?= Url::to(['masters/export']) ?>'>Экспорт в эксель мастеров</a></li>
            </ul>
        </div>
    </div>
</div>

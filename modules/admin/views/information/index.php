...
<div class="greyBg clear">
    <div class="content">
        ...
        <div class="adminMastersList">
            ...
            <ul>
                <li><a href='<?= Url::to(['information/create']) ?>'>Создать статью</a></li>
                <li><a href='<?= Url::to(['information/delete']) ?>'>Удалить статью</a></li>
                <li><a href='<?= Url::to(['information/reduction']) ?>'>Редактировать статью</a></li>
            </ul>
        </div>
    </div>
</div>

    ...
    <div class="greyBg clear">
        <div class="content">
            ...
            <div class="adminMastersList">
                ...
                <form action="<?= Url::to (['/admin/admin/delete-information']) ?>" class="hidden">
                    <div class='informationDeleteContainer'>
                        ...
                        <?/*
                        foreach ($informations as $information) {
                            $link = Url::to(['//information/information-full', 'id' => $information['id'], 'title' => $information['title']]);
                            echo "<div class='labelPlusCheckbox'>
                                <input type='checkbox' name='{$information['id']}' value='{$information['id']}' id='{$information['id']}'/>
                                <label class='checkbox' for='{$information['id']}'>{$information['title']}</label>
